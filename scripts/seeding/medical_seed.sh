...
OUTPUT_SEED_PATH=${OUTPUT_SEED_PATH:-data/medical_seed_io.jsonl}
OUTPUT_ERROR_SEED_PATH=${OUTPUT_ERROR_SEED_PATH:-data/medical_error_seed_io.jsonl}
OUTPUT_CODE_F_SEED_PATH=${OUTPUT_CODE_F_SEED_PATH:-data/medical_code_f_seed_io.jsonl}
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    trainer.project_name='azr_medical' \
    trainer.experiment_name='medical_seed_7b' \
    ...
    azr.seed_dataset=data/medical_seed_io.jsonl \
    azr.error_seed_dataset=null \
    azr.code_f_seed_dataset=data/medical_seed_io_extended.jsonl \
    ...
    trainer.debug=False \
    azr.reward.generation_reward_config.complexity_reward.coef=0.1 \
    azr.reward.generation_reward_config.complexity_reward.max=0.3 \
    azr.reward.generation_reward_config.complexity_reward.enabled=True \
    azr.reward.generation_reward_config.mean_edit_distance_reward.coef=0.05 \
    azr.reward.generation_reward_config.mean_edit_distance_reward.max=0.2 \
    azr.reward.generation_reward_config.mean_edit_distance_reward.enabled=True \
    azr.reward.generation_reward_config.halstead_reward.coef=0.1 \
    azr.reward.generation_reward_config.halstead_reward.max=0.3 \
    azr.reward.generation_reward_config.halstead_reward.enabled=True \
    azr.reward.generation_reward_config.answer_diversity_reward.coef=0.05 \
    azr.reward.generation_reward_config.answer_diversity_reward.max=0.2 \
