...
OUTPUT_SEED_PATH=${OUTPUT_SEED_PATH:-data/3b_coder_medical_enhanced_seed_io.jsonl}
OUTPUT_ERROR_SEED_PATH=${OUTPUT_ERROR_SEED_PATH:-data/3b_coder_medical_enhanced_error_seed_io.jsonl}
OUTPUT_CODE_F_SEED_PATH=${OUTPUT_CODE_F_SEED_PATH:-data/3b_coder_medical_enhanced_code_f_seed_io.jsonl}
...
python -m absolute_zero_reasoner.main_azr_ppo \
    ...
    trainer.project_name='azr_medical_enhanced' \
    trainer.experiment_name='azr_medical_enhanced_coder3b' \
    ...
    azr.seed_dataset=data/3b_coder_medical_enhanced_seed_io.jsonl \
    azr.output_seed_path=data/3b_coder_medical_enhanced_seed_io.jsonl \
    azr.error_seed_dataset=data/3b_coder_medical_enhanced_error_seed_io.jsonl \
    azr.output_error_seed_path=data/3b_coder_medical_enhanced_error_seed_io.jsonl \
    azr.code_f_seed_dataset=data/3b_coder_medical_enhanced_code_f_seed_io.jsonl \
    azr.output_code_f_seed_path=data/3b_coder_medical_enhanced_code_f_seed_io.jsonl \
    ...
    trainer.debug=False \
    azr.reward.generation_reward_config.complexity_reward.coef=0.08 \
    azr.reward.generation_reward_config.complexity_reward.max=0.25 \
    azr.reward.generation_reward_config.complexity_reward.enabled=True \
    azr.reward.generation_reward_config.mean_edit_distance_reward.coef=0.04 \
    azr.reward.generation_reward_config.mean_edit_distance_reward.max=0.15 \
    azr.reward.generation_reward_config.mean_edit_distance_reward.enabled=True \
    azr.reward.generation_reward_config.halstead_reward.coef=0.08 \
    azr.reward.generation_reward_config.halstead_reward.max=0.25 \
    azr.reward.generation_reward_config.halstead_reward.enabled=True \
    azr.reward.generation_reward_config.answer_diversity_reward.coef=0.04 \
    azr.reward.generation_reward_config.answer_diversity_reward.max=0.15 \
    azr.reward.generation_reward_config.answer_diversity_reward.enabled=True \
